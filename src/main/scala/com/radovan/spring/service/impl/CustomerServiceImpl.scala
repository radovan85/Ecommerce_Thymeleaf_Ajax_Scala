...
class CustomerServiceImpl extends CustomerService {
  ...
  @Autowired
  private var billAddressRepository:BillingAddressRepository = _
  ...
  override def storeCustomer(form: RegistrationForm): CustomerDto = {
    ...
    val billAddressDto = form.getBillingAddress
    val billAddressEntity = tempConverter.billingAddressDtoToEntity(billAddressDto)
    val storedBillAddress = billAddressRepository.save(billAddressEntity)
